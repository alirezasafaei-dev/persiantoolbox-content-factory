...
def build_copy_deck(title: str, category: Category, summary: str = "") -> CopyDeck:
    ...
    if category == Category.PDF_TUTORIAL or "PDF" in short.upper():
        ...
        alt = "طرح معرفی مجموعه ابزارهای مدیریت PDF پرشین‌تولباکس با کارت‌های سند و مسیر انتخاب ابزار"
        ...
        effect = (
            "کاربر ابتدا کار فعلی خود را تشخیص می‌دهد و سپس مجموعه ابزارهای مرتبط را بررسی می‌کند."
        )

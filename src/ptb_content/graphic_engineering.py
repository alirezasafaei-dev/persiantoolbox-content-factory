...
CATEGORY_LABELS: dict[Category, str] = {
    ...
    Category.PDF_TUTORIAL: "ابزارهای PDF",
...
def build_copy_deck(title: str, category: Category, summary: str = "") -> CopyDeck:
    ...
    if category == Category.PDF_TUTORIAL or "PDF" in short.upper():
        headline = "فایل PDF دارید؟\nابزار مربوط به کارتان را پیدا کنید"
        supporting = (
            "مجموعه ابزارهای PDF اداری و استخدامی را یک‌جا ببینید و بر اساس نیازتان انتخاب کنید."
        )
        cta = "ابزارهای PDF را ببینید"
        alt = "طرح معرفی مجموعه ابزارهای PDF اداری و استخدامی با کارت‌های سند و مسیر انتخاب ابزار"
        problem = "کاربر فایل PDF دارد، اما برای کار فعلی‌اش ابزار مناسب را نمی‌شناسد"
        value = (
            "در صفحه ابزارهای PDF، مجموعه ابزارهای اداری و استخدامی را یک‌جا می‌بینید "
            "و بر اساس نیازتان انتخاب می‌کنید"
        )
        goal = "ترغیب کاربر به مشاهده صفحه ابزارهای PDF پس از تشخیص نیاز شخصی"
        principle = "فعال‌سازی نیاز شخصی و کاهش اضافه‌بار انتخاب"
        effect = "پرسش آغازین، کاربر را وادار می‌کند مسئله فعلی‌اش را به یک انتخاب مشخص پیوند بزند."
        lead = "فایل PDF دارید و نمی‌دانید برای کار فعلی‌تان باید سراغ کدام ابزار بروید؟"

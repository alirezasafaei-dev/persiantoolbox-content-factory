...
CATEGORY_LABELS: dict[Category, str] = {
    ...
    Category.PDF_TUTORIAL: "مدیریت PDF",
...
def build_copy_deck(title: str, category: Category, summary: str = "") -> CopyDeck:
    ...
    if category == Category.PDF_TUTORIAL or "PDF" in short.upper():
        headline = "ابزار PDF را\nبر اساس کارتان انتخاب کنید"
        supporting = (
            "مجموعه ابزارهای مدیریت PDF را یک‌جا ببینید و برای کار فعلی‌تان "
            "گزینه مرتبط را بررسی کنید."
        )
        cta = "ابزارهای PDF را بررسی کنید"
        alt = (
            "طرح معرفی مجموعه ابزارهای مدیریت PDF پرشین‌تولباکس با کارت‌های سند "
            "و مسیر انتخاب ابزار"
        )
        problem = "جست‌وجوی پراکنده و انتخاب ابزار نامرتبط برای مدیریت فایل PDF"
        value = "نمایش مجموعه ابزارهای مدیریت PDF در یک مسیر موضوعی"
        goal = "هدایت کاربر از شناخت مسئله به بررسی صفحه مجموعه ابزارهای PDF"
        principle = "کاهش بار شناختی و ابهام انتخاب"
        effect = (
            "کاربر ابتدا کار فعلی خود را تشخیص می‌دهد و سپس مجموعه ابزارهای مرتبط را "
            "بررسی می‌کند."
        )
        lead = "برای کار با PDF، لازم نیست میان ابزارهای پراکنده سردرگم شوید."
    elif category == Category.PERSIAN_TEXT:
        headline = "متن فارسی را\nپیش از انتشار مرتب کنید"
        supporting = (
            "ابزارهای پاک‌سازی و استانداردسازی متن را متناسب با مسئله‌ای که دارید "
            "بررسی کنید."
        )
        ...
        value = "دسترسی موضوعی به ابزارهای پاک‌سازی و استانداردسازی متن فارسی"
        ...
        lead = "متن فارسی نامرتب، خوانایی و اعتماد مخاطب را کاهش می‌دهد."
    elif category == Category.PRIVACY:
        headline = "پیش از استفاده،\nنحوه پردازش داده را بررسی کنید"
        supporting = (
            "اطلاعات منبع را بخوانید و متناسب با حساسیت داده‌های خود تصمیم بگیرید."
        )
        ...
        value = "قرار دادن اطلاعات لازم برای یک انتخاب آگاهانه در مرکز پیام"
        ...
        supporting = (
            "کاربرد معرفی‌شده در منبع را بررسی کنید و ببینید با نیاز فعلی شما "
            "هم‌خوانی دارد یا نه."
        )
        ...
        value = "توضیح کاربرد ابزار پیش از دعوت به استفاده"

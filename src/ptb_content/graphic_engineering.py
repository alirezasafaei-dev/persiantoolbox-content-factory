...
def build_copy_deck(title: str, category: Category, summary: str = "") -> CopyDeck:
    ...
    if category == Category.PDF_TUTORIAL or "PDF" in short.upper():
        ...
        value = (
            "در صفحه ابزارهای PDF، ابزارهای این دو حوزه را یک‌جا می‌بینید و بر اساس کاری که "
        ...
        lead = "گاهی فایل PDF شما به یک کار اداری مربوط است و گاهی به مدارک استخدامی."

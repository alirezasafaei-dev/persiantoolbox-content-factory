...
def build_copy_deck(title: str, category: Category, summary: str = "") -> CopyDeck:
    ...
    if category == Category.PDF_TUTORIAL or "PDF" in short.upper():
        ...
        supporting = (
            "ابزارهای اداری و استخدامی مرتبط با PDF را یک‌جا ببینید و بر اساس نیازتان انتخاب کنید."
        )
        ...
        value = (
            "در صفحه ابزارهای PDF، ابزارهای اداری و استخدامی را یک‌جا می‌بینید و بر اساس "
            "نیازتان انتخاب می‌کنید"
        )
